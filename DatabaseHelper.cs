...
namespace WpfApp1
{
    public static class DatabaseHelper
    {
        ...
        public static readonly string ConnectionString =
     @"Data Source=.\SQLEXPRESS;Initial Catalog=Payslip;Integrated Security=True;Encrypt=False;";
...
";
        ...
        END";
            ...
            string createLeaveReqsTableQuery = @"
    IF NOT EXISTS (
        SELECT * FROM INFORMATION_SCHEMA.TABLES 
        WHERE TABLE_NAME = 'leavereqs'
    )
    ...
    END";
            cmd = new SqlCommand(createLeaveReqsTableQuery, connection);
            cmd.ExecuteNonQuery();
        }
    }
}
